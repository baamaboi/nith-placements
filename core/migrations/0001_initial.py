# Generated by Django 4.0.1 on 2023-01-07 09:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('stipend_offered', models.DecimalField(blank=True, decimal_places=2, max_digits=12, null=True, verbose_name='Stipend offered')),
                ...
                ('drive_status', models.CharField(blank=True, choices=[('Upcomming', 'Upcomming'), ('Complete', 'Complete'), ('Ongoing', 'Ongoing')], max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('offer_letter', models.JSONField(null=True, verbose_name='Offer Letter Status')),
        ...
        migrations.AddField(
            model_name='myuser',
            name='roll',
            field=models.OneToOneField(blank=True, help_text='Student association if the user is a student.', null=True, on_delete=django.db.models.deletion.CASCADE, to='core.student', verbose_name='Roll Number (If Student)'),
        ),
        migrations.AddField(
            model_name='myuser',
